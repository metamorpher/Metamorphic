...
using Metamorphic.Agent.Nuclei.AppDomains;
using Nuclei;
...
namespace Metamorphic.Agent
{
    ...
    internal static class DependencyInjection
    {
        ...
        /// </summary>
        private const string DefaultInfoFileName = "agent.info.log";
        ...
        public static IContainer CreateContainer()
        {
            var builder = new ContainerBuilder();
            {
                builder.Register(c => new XmlConfiguration(
                        AgentConfigurationKeys.ToCollection()
                            ...
                            .ToList(),
                        AgentConstants.ConfigurationSectionApplicationSettings))
                    .As<IConfiguration>()
                    .SingleInstance();
